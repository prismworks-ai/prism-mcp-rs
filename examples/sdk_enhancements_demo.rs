...
async fn demonstrate_session_methods(client: &mut prism_mcp_rs::client::McpClient) -> McpResult<()> {
            ...
            if let Some(content) = result.content {
                for item in content {
                    match item {
                        ...
                        ToolResponseContent::Image { data, mime_type, .. } => {
